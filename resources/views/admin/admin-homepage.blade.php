              ...
              <tr>
                ...
                <td data-label="ID Card">
                  @if($employee->id_card_image)
                    <a href="javascript:void(0)" onclick="showIdImage('/storage/uploads/{{ $employee->id_card_image }}', '{{ $employee->first_name }} {{ $employee->last_name }} Government Issued ID')" style="color: #1E63E9; text-decoration: underline;">View Government Issued ID</a>
                  @else
          ...
          data.data.forEach(user => {
              ...
              row.innerHTML = `
                  ...
                  <td data-label="ID Uploaded">
                      ${user.id_image ? 
                          `<a href="javascript:void(0)" onclick="showIdImage('/storage/uploads/${user.id_image}', '${user.first_name} ${user.last_name} Government Issued ID')" style="color: #1E63E9; text-decoration: underline;">View Government Issued ID</a>` :
